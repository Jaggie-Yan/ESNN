...
def final_model_fn(features, labels, mode, params):
  """The model_fn for the searched architecture found by NAS.
  ...
  # get predicted logits of the searched architecture found by NAS
  logits, num_of_spikes, num_of_synops = models.build_model(
      input_images,
  ...
  if is_training:
    ...
    def summary_fn(loss, num_of_spikes, num_of_synops, lr, ce):
    ...
    summary_fn(loss_t, num_of_spikes_t, num_of_synops_t, lr_t, ce_t)
